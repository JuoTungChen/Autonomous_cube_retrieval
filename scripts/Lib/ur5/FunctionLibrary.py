...
class FunctionLib:
    ...
    def go(self, x, y, z, roll, pitch ,yaw, pour=False, orientation_constraint=True, position_constraint=True, joint_constraint=True, velocity=1.0, acceleration=0.8):
            ori=self.euler_to_quaternion(roll,pitch,yaw)
    ...
    def setup_the_scene(self):
        self.add_box_to_workspace("workbench_1", x=0.44, y=-0.37, z=-0.53, sx=1.52, sy=0.61, sz=0.715)
